<?php
/* Smarty version 5.6.0, created on 2025-11-20 13:51:34
  from 'file:layout_user.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.6.0',
  'unifunc' => 'content_691f1ce62ab6e5_05757386',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f893be7a1dd7debce71082a15493b5cfeb7e9787' => 
    array (
      0 => 'layout_user.tpl',
      1 => 1763646687,
      2 => 'file',
...
function content_691f1ce62ab6e5_05757386 (\Smarty\Template $_smarty_tpl) {
...
<title><?php echo (($tmp = $_smarty_tpl->getValue('title') ?? null)===null||$tmp==='' ? 'Dashboard' ?? null : $tmp);?>
 | Perpusku</title>
...
<nav class="navbar navbar-expand-lg navbar-custom fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand" href="<?php echo $_smarty_tpl->getValue('base_url');?>
/user/dashboard">
...
/user/dashboard">Beranda</a></li>
        <li class="nav-item"><a class="nav-link" href="<?php echo $_smarty_tpl->getValue('base_url');?>
/user/books">Daftar Buku</a></li>
        <li class="nav-item"><a class="nav-link" href="<?php echo $_smarty_tpl->getValue('base_url');?>
/user/mybooks">Buku Saya</a></li>
        <li class="nav-item"><a class="nav-link" href="<?php echo $_smarty_tpl->getValue('base_url');?>
/user/reviews">Riwayat</a></li>
      </ul>
...
/user/cart" class="position-relative">
          ...
          <?php if ((true && ($_smarty_tpl->hasVariable('cart_count') && null !== ($_smarty_tpl->getValue('cart_count') ?? null))) && $_smarty_tpl->getValue('cart_count') > 0) {?>
            <span class="nav-badge"><?php echo $_smarty_tpl->getValue('cart_count');?>
</span>
          <?php }?>
        </a>
        <a href="<?php echo $_smarty_tpl->getValue('base_url');?>
/user/favorites" class="position-relative ms-3">
          <i class="bi bi-heart-fill"></i>
          <?php if ((true && ($_smarty_tpl->hasVariable('fav_count') && null !== ($_smarty_tpl->getValue('fav_count') ?? null))) && $_smarty_tpl->getValue('fav_count') > 0) {?>
            <span class="nav-badge"><?php echo $_smarty_tpl->getValue('fav_count');?>
</span>
          <?php }?>
        </a>
        <a href="<?php echo $_smarty_tpl->getValue('base_url');?>
/user/profile" class="ms-3">
          <i class="bi bi-person-circle fs-5"></i>
        </a>
        <form action="<?php echo $_smarty_tpl->getValue('base_url');?>
/logout" method="get" class="ms-3 m-0 d-inline">
...
<div class="container main-content-area">
    <?php 
$_smarty_tpl->getInheritance()->instanceBlock($_smarty_tpl, 'Block_1246468530691f1ce62a5333_30682990', 'main_content');
?>
...
<?php }
/* {block 'main_content'} */
class Block_1246468530691f1ce62a5333_30682990 extends \Smarty\Runtime\Block
{
