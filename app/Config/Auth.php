...
class Auth extends ShieldAuth
{
    ...
    public array $responses = [
        'login'    => \App\Authentication\LoginResponse::class,
        'register' => \CodeIgniter\Shield\Authentication\Actions\RegisterResponse::class,
        'logout'   => \CodeIgniter\Shield\Authentication\Actions\LogoutResponse::class,
    ];
    ...
    public array $actions = [
        'register' => null,
        'login'    => null, // jangan isi class custom, biarkan null
    ];
